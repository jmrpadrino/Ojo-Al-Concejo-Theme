                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-11"><?php echo $carpeta['description']; ?></div>
                                                        </div>
                                                        <hr />
                                                    ...
                                                    <div class="col-sm-3 text-center">
                                                        <div class="d-flex h-100 flex-column justify-content-center align-items-center">
                                                            <a href="https://twitter.com/intent/tweet?text=<?php echo get_post_meta(get_the_ID(),'oda_ciudad_tweet_folders', true) . ' - ' . get_post_meta(get_the_ID(),'oda_ciudad_twitter_user', true); ?>" style="text-decoration: none;">
