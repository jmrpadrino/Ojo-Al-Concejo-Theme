        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="align-middle" style="text-align:center; line-height:1" scope="col" width="130"><span class="fs-16">Suplente en votaciones</span></th>
                    ...
                    <th class="align-middle" style="text-align:center; line-height:1" scope="col" width="130"><span class="fs-16">% de participación del suplente a votaciones</span></th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr <?php echo ($index > 2) ? 'class="hidden-row d-none" ' : ''?> >
                    ...
                    <td class="align-middle" style="text-align:center;"><?php echo $rank['de'] ?></td>
                    <td class="align-middle" style="text-align:center;"><?php echo $mociones_validas ?></td>
                    <td class="align-middle" style="text-align:center;"><?php echo ($rank['de'] > 0) ? number_format(($rank['de']*100) / $mociones_validas,0) . '%' : ''; ?></td>
                </tr>
                <?php 
                    if ($index == 4){ break; }
                } 
