        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="align-middle" style="text-align:center; line-height:1" scope="col" width="130"><span class="fs-16">% de participación del duplente a votaciones</span></th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr <?php echo ($index > 2) ? 'class="hidden-row d-none" ' : ''?> >
                    ...
                    <td class="align-middle" style="text-align:center;"><?php echo ($rank['de'] > 0) ? number_format(($rank['de']*100) / $rank['total'],0) . '%' : ''; ?></td>
                </tr>
                <?php 
                    if ($index == 4){ break; }
                } 
