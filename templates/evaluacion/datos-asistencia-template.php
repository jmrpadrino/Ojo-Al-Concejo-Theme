        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="align-middle" style="text-align:center; line-height:1" scope="col" width="130"><span class="fs-16">Asistencia a votaciones</span></th>
