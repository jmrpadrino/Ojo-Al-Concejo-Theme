        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="align-middle" style="text-align:center; line-height:1" scope="col" width="300"><span class="fs-16">Número de solicitudes de información</span></th>
                </tr>
            </thead>
            <tbody>
                <?php
