        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="align-middle" style="text-align:center; line-height:1" scope="col" width="300"><span class="fs-16">Proyectos de ordenanzas</span></th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr <?php echo ($index > 2) ? 'class="hidden-row d-none" ' : ''?>>
                    ...
                    <td class="align-middle" style="text-align:center;"><?php echo $rank['or'] ?></td>
                </tr>
                <?php 
                    if ($index == 4){ break; }
                } 
