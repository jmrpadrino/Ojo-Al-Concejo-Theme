    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-12 col-lg-3">
                <div class="row">
                    <div class="col">
                        <h1 class="fs-18 bold">Proyectos de resolución</h1>
                        ...
                        <div class="col-12">
                            <div class="accordion listado-documentos" id="listadodocumentos">
                                ...
                                while ($documentos->have_posts()) {
                                    $documentos->the_post();
                                    $proponente = get_post_meta(get_the_ID(), 'oda_resolucion_iniciativa', true);
                                    ...
                                    switch($proponente){
                                        ...
                                        case 'concejal': 
                                            $concejal = '';
                                            $elementos = get_post_meta(get_the_ID(), 'oda_resolucion_miembros', true);
